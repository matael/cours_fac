...
titre3_1=['niveau de pression rayonné à ',num2str(r),' mètre, pour une puissance électrique de',num2str(P_elec_1k),' W (à  1kHz)'];  
titre3_2=['différence de phase entre la pression rayonnnée à ',num2str(r),' mètre, et la tension Ug appliquée']; 
...
figure(4);
subplot(211);
semilogx(freq,abs(vmembr_Ug));xlabel('frequence (Hz)');ylabel('|v_{mb}/U_g| (m/s/V)');
subplot(212);
...
MM=mean(eta(58:1160))
MN=sum(eta(58:1160))/(1160-58)

figure(1)
print('-dpng','Zray_baffle_infini.png');
figure(2)
print('-dpng','Bode_Zhp_baffle_infini.png');
figure(3)
print('-dpng','Bode_Lp_1m_baffle_infini.png');
figure(4)
print('-dpng','Vmb_Ug_baffle_infini.png');
figure(5)
print('-dpng','Rendement_eac_baffle_infini.png');

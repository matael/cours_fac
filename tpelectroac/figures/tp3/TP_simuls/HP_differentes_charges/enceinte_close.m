...
titre2_1=['niveau de pression rayonné à ',num2str(r),' mètre, pour une puissance électrique de',num2str(P_elec_1k),' W (à  1kHz)'];  
titre2_2=['différence de phase entre la pression rayonnnée à ',num2str(r),' mètre, et la tension Ug appliquée']; 
...
eta=P_acoust./P_elec;
titre4=['rendement électroacoustique en fonction de la fréquence'];
